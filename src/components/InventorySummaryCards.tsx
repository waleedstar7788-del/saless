  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="card p-4 sm:p-5 bg-gradient-to-l from-blue-600 to-blue-700 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-fluid-xl sm:text-2xl md:text-3xl font-bold mt-1">{formatCurrency(totalCost)}</p>
        ...
        <div className="card p-4 sm:p-5 bg-gradient-to-l from-red-600 to-red-700 text-white">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-white/20 rounded-xl shrink-0">
            ...
            <div>
              ...
              <p className="text-fluid-xl sm:text-2xl md:text-3xl font-bold mt-1">{formatCurrency(totalSale)}</p>
